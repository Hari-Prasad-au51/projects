...
//console.log(Token)
    useEffect(() => {
  socket.current = io("https://socknew.harry-potter1.repl.co");
...
<div className="messenger">
         <div className="chatMenu">
           <div className="chatMenuWrapper ">
             <input placeholder="Search your seller or buyers" className="chatMenuInput" onChange={(e) => setSearchQuery(e.target.value)} />
...
setActiveConversation(c)  }}     style={{
                ...
                <Conversation conversation={c} currentUser={current_user} onlineUsers={ onlineUsers }  searchQuery={searchQuery}/>
        </div>
          ))}                 
  </div>
   </div>
