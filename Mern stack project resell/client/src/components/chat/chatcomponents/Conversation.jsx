...
export default function Conversation({ conversation, currentUser,onlineUsers,searchQuery }) {
...
//console.log(searchQuery)
 const isMatch = (str) => {
  ...
  return (
    <div className="conversation" style={isMatch(user[0].firstname) ? {} : { display: 'none' }}>
